...
const apiUpdate = api + '/api/brands/update'
const apiGetBrandById = api + '/api/brands/'
...
const Update = props => {
    ...
    const [brandDataID, setBrandDataID] = useState([])
    ...
    const handleUpdateBrandApi = async () => {
        setCreateLoading(true)
        await axios
            .patch(apiUpdate, brandData)
            .catch(() =>
    ...
    const getBrandById = () => {
        axios
            .get(apiGetBrandById + `id=${props.id}`)
            .then(res => setBrandDataID(res.data))
    }

    const handleUpdateBrand = () => {
        handleUpdateBrandApi()
    }
